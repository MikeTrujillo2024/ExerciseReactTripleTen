...
function Time() {
  ...
  React.useEffect(() => {
    ...
    /**
   * se agrega un efecto de gong cuando se crea el componente
   * y este tiene una dependencia vacio para garantizar que  solo se ejecute una sola vez
   */
  React.useEffect(() => {
    playSound('gong.mp3');

    /*
    sonara cuando este sea desmontado
    */
    return () => {
      playSound('gong.mp3');
    };
